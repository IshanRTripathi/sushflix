      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-indigo-600">Sushflix</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:support@sushflix.com" className="text-gray-600 hover:text-indigo-600">
                  support@sushflix.com
                </a>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-gray-400 text-sm text-center">
            © {new Date().getFullYear()} Sushflix. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
